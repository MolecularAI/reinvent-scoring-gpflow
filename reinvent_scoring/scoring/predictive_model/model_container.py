...
from reinvent_scoring.scoring.predictive_model.gpflow_model_container import GPflowModelContainer
    ...
    def __new__(cls, activity_model: Any, specific_parameters: Dict) -> BaseModelContainer:
        ...
        if container_type == _container_type.SCIKIT_CONTAINER:
            container_instance = ScikitModelContainer(activity_model,
                                                      ...
                                                      specific_parameters)
        elif container_type == _container_type.GPFLOW_CONTAINER:
            container_instance = GPflowModelContainer(activity_model,
                                                      specific_parameters[_component_specific_parameters.GPFLOW],
                                                      specific_parameters)
        else:
