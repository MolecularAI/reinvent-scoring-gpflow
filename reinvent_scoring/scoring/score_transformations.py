...
class TransformationFactory:
    ...
    def clipping(self, predictions: list, parameters: dict) -> np.array:
        _low = parameters[TransformationParametersEnum.LOW]
        _high = parameters[TransformationParametersEnum.HIGH]
        predictions = predictions.numpy()
        predictions[predictions<_low] = _low
        predictions[predictions>_high] = _high
        return predictions
